...
import { ForgotPasswordFormValues, RegisterFormValues, ResetPasswordFormValues, VerifyFormValues } from "@/@types";
...
export const authService = {
    ...
    async resetPassword(data: ResetPasswordFormValues) {
         const { token, ...body } = data;
        // Backend mengharapkan body: { password } Dan Header: Authorization: Bearer <token>
