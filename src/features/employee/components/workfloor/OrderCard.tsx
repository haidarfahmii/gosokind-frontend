            ...
            >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-right">
                  <span className="text-[10px] uppercase text-gray-400 font-bold tracking-wider block mb-0.5">
                    Expected
                  </span>
                ...
                {/* Actual qty input — hidden for PACKING (just confirm) */}
                {station !== "PACKING" && (
                  <div className="text-right">
